...
namespace TkHLSL.Unity
{
    ...
    ///     shader. <see cref="TkHLSL.SourceGeneration" />'s generator looks for this attribute (by its
    ...
    public sealed class ComputeShaderBindingAttribute : Attribute
    {
        ...
        ///     normalized path (see <see cref="TkHLSL.SourceGeneration" />'s generator), so
        ...
        ///     through to <see cref="TkHLSL.Preprocessing.HlslParseOptions.DefinedSymbols" />. A shader
