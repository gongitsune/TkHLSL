...
///     (see docs/IMPLEMENTATION_PLAN.md §9 Phase 9.2) — <see cref="TkHLSL.SourceGeneration.Generator.ComputeShaderBindingGenerator" />'s
...
///     <see cref="TkHLSL.SourceGeneration.Diagnostics.TkHlslDiagnostics.ById" /> plus plain-value message
