...
internal static class TkHlslDiagnostics
{
    ...
    /// <summary>An HLSL parse error, transcribed from a <see cref="TkHLSL.Diagnostics.Diagnostic" /> of <see cref="TkHLSL.Diagnostics.DiagnosticSeverity.Error" />. Generation for this file is skipped.</summary>
    public static readonly DiagnosticDescriptor HlslError = new(
        "TKH0001", "HLSL の解析に失敗しました",
        "'{0}' の解析でエラーが発生しました: {1}",
        Category, DiagnosticSeverity.Error, true);

    /// <summary>An HLSL parse warning, transcribed from a <see cref="TkHLSL.Diagnostics.Diagnostic" /> of <see cref="TkHLSL.Diagnostics.DiagnosticSeverity.Warning" />.</summary>
