...
namespace Tk.Hlsl.Unity
{
    /// <summary>
    ///     Marks a <c>partial class</c> or <c>partial struct</c> as the binding surface for a compute
    ///     shader. <see cref="Tk.Hlsl.SourceGeneration" />'s generator looks for this attribute (by its
    ...
    public sealed class ComputeShaderBindingAttribute : Attribute
    {
        ...
        ///     normalized path (see <see cref="Tk.Hlsl.SourceGeneration" />'s generator), so
        ...
        ///     through to <see cref="Tk.Hlsl.Preprocessing.HlslParseOptions.DefinedSymbols" />. A shader
