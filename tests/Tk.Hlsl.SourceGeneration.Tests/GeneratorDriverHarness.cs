...
internal static class GeneratorDriverHarness
{
    ...
    /// <summary>Every runtime assembly the current process was loaded with, plus Tk.Hlsl.Unity — the simplest reliable way to get a complete BCL reference set for an in-process test compilation.</summary>
