...
using Tk.Hlsl.SourceGeneration.Diagnostics;
...
///     <c>[Tk.Hlsl.Unity.ComputeShaderBinding("...")]</c> — see docs/IMPLEMENTATION_PLAN.md §9 Phase 9.
...
{
    private const string AttributeMetadataName = "Tk.Hlsl.Unity.ComputeShaderBindingAttribute";
