...
///         are silently skipped rather than reported as a diagnostic — TkHLSL has no intrinsic-function
    ...
    private sealed class State
    {
            ...
            HashSet<Handle<GlobalVariable>>? globalUses)
        {
            ...
            if (!followedByCall || !TryGetFunctionIndex(text, out var calleeIndex) || calleeIndex >= selfIndex)
                ...
                // forward reference — none of which TkHLSL resolves; see the "Known limitations" remarks).
                return globalUses;
