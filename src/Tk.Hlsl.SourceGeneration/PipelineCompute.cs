...
using Tk.Hlsl.SourceGeneration.Emit;
...
///     <see cref="Tk.Hlsl.HlslParser" />, and renders the generated source — see
...
internal static class PipelineCompute
{
        ...
        (AttributeTargetInfo Target, EquatableArray<AdditionalHlslFile> Files) input)
    {
        ...
        {
            var id = d.Severity == Tk.Hlsl.Diagnostics.DiagnosticSeverity.Error ? "TKH0001" : "TKH0002";
    ...
    /// </summary>
    internal static EmitDiagnosticInfo MakeHlslDiagnostic(string id, Tk.Hlsl.Model.HlslCompilationResult result,
        Tk.Hlsl.Text.TextSpan span, IReadOnlyDictionary<string, string> filesByPath, string fallbackPath,
