...
namespace Tk.Hlsl.SourceGeneration.Diagnostics;

/// <summary>
///     Every <see cref="DiagnosticDescriptor" /> <see cref="Generator.ComputeShaderBindingGenerator" />
///     can report, collected in one place (see docs/IMPLEMENTATION_PLAN.md §9 Phase 9.3).
/// </summary>
internal static class TkHlslDiagnostics
{
    private const string Category = "Tk.Hlsl.SourceGeneration";

    /// <summary>An HLSL parse error, transcribed from a <see cref="Tk.Hlsl.Diagnostics.Diagnostic" /> of <see cref="Tk.Hlsl.Diagnostics.DiagnosticSeverity.Error" />. Generation for this file is skipped.</summary>
    public static readonly DiagnosticDescriptor HlslError = new(
        "TKH0001", "HLSL の解析に失敗しました",
        "'{0}' の解析でエラーが発生しました: {1}",
        Category, DiagnosticSeverity.Error, true);

    /// <summary>An HLSL parse warning, transcribed from a <see cref="Tk.Hlsl.Diagnostics.Diagnostic" /> of <see cref="Tk.Hlsl.Diagnostics.DiagnosticSeverity.Warning" />.</summary>
    ...
    /// <summary>Every descriptor above, keyed by <see cref="DiagnosticDescriptor.Id" />, for reconstructing a <see cref="Diagnostic" /> from a cached <see cref="SourceGeneration.EmitDiagnosticInfo" />.</summary>
